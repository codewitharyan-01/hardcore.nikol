...
# Find all Unsplash URLs in inline styles (url('...'))
urls = re.findall(r"url\('(https://images\.unsplash\.com/[^']+)'\)", html_content)
urls = list(set(urls)) # unique

for idx, url in enumerate(urls):
    local_filename = f'unsplash_bg_{idx}.webp'
...
print('Done downloading and updating background HTML.')
